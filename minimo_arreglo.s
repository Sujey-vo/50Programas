...
_start:
    ...
    ldr x3, =min_val                  // Cargar la dirección de min_val en x3
    str w2, [x3]                      // Guardar el primer elemento en min_val
...
loop:
    ...
    // Comparar el elemento actual con el valor mínimo
    ldr w6, [x3]                      // Cargar min_val en w6
    cmp w5, w6                        // Comparar w5 con w6
    bge skip                          // Si w5 >= w6, saltar

    // Actualizar el valor mínimo
    str w5, [x3]                      // Guardar el nuevo mínimo en min_val
...
print_result:
    // Imprimir el mensaje "El minimo es: "
    ...
    // Imprimir el valor mínimo como número
    ldr w0, [x3]                      // Cargar min_val en w0
